...
public class UserService {
    ...
    public User registerNewUser(UserDTO userDTO) {
        ...
        user.setPhoneNumber(normalizePhoneNumber(userDTO.getPhoneNumber()));
    ...
    @Transactional
    public boolean updateUserPassword(String username, String newRawPassword) {
        ...
        return false; // 사용자를 찾을 수 없거나 업데이트 실패
    }
    // ⭐⭐⭐ 새로운 메서드 추가 끝 ⭐⭐⭐
}