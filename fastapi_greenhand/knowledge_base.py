...
agricultural_knowledge_base = { 
    ...
    "딸기 수확 시기": { 
        ...
        "details": "노지 딸기는 보통 4월 말에서 6월 초에 수확이 시작되며, 시설 재배의 경우 겨울철에도 수확이 가능합니다. 딸기 열매 전체가 붉게 익었을 때가 수확 적기이며, 너무 오래 두면 무르거나 병에 걸리기 쉬으니 주의해야 합니다. 수확은 보통 아침 일찍 하는 것이 신선도 유지에 유리합니다." 
    }, 
    "스마트팜이란?": { 
